...
③ 机遇与风险（绝不展开任何具体内容）：固定收尾一句"——而你真正的机遇与风险，都藏在完整报告里，等待解锁……"。**绝对禁止写出任何具体的机遇点或风险点**，一个字都不给，只留这一句吊住用户]
JINJING_END
HOOK_START
[一句钩子句，必须用"不是…，而是……"的截断结构。格式：你的未来不是[一个基于此人真实数据、看似合理的表层说法，如"靠一个个爆款作品堆砌出来的"]，而是……
**铁律：在"而是"后立即用省略号截断，绝对不能写出后半句答案**——留下认知缺口，让用户为了知道那个"而是"后面是什么而解锁。整句走心，紧扣此人独有数据，表层说法要像那么回事但不是真正答案]
HOOK_END`;
