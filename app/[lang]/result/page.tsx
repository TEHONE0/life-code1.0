...
// 型号×层级注解 81 条（F导 2026-06-12 确认版）：Lv.1–6 用 Riso-Hudson 原版头衔（好懂得体），
// Lv.7–9 用软化版（去病理标签·带出口），仅中文报告显示
const HEALTH_NOTES: Record<string, string[]> = {
  完美: ["睿智的现实主义者", "理性的人", "讲求原则的导师", "理想主义的改革者", "讲求秩序的人", "好评判的完美主义者", "容易钻牛角尖 · 试着放过不完美", "对自己太严苛 · 请先放过自己", "被愤怒困住 · 请寻求支持"],
  助人: ["不求回报的利他主义者", "真诚的关怀者", "扶持性的助人者", "热情洋溢的朋友", "占有性的“密友”", "自负的“圣徒”", "付出藏着期待 · 先承认自己的需要", "用付出绑住人 · 学着放手", "身体在替你喊累 · 请立即求助"],
  成就: ["真诚的人", "自信的人", "杰出的典范", "有好胜心的成就者", "以貌取人的实用主义者", "自我推销的自恋者", "容易走捷径 · 诚实最稳", "活在面具里 · 请先停下歇歇", "输不起的执念 · 请寻求支持"],
  独特: ["灵性的创造者", "自省的直觉者", "自我表露的个性", "富有想象力的唯美主义者", "自我陶醉的浪漫主义者", "自我放纵的“例外”", "容易陷入低落 · 出口一直都在", "情绪压得很重 · 请抓住一个人", "有自伤的念头 · 请立即寻求支援"],
  思考: ["开先河的幻想家", "感知性的观察者", "专注的创新者", "勤奋的专家", "狂热的理论家", "挑衅的愤世嫉俗者", "容易把自己关起来 · 虚无不是真相", "和现实有点脱节 · 请重建一条连接", "内在隔离很深 · 请立即寻求支援"],
  警觉: ["勇敢的英雄", "迷人的朋友", "忠诚的伙伴", "尽职尽责的忠诚者", "矛盾的悲观主义者", "独裁的反叛者", "焦虑容易过载 · 先找个安全的锚", "疑心压过判断 · 请先相信一个人", "容易自我攻击 · 请立即寻求支援"],
  体验: ["入迷的鉴赏家", "热情洋溢的乐天派", "多才多艺的全才", "经验丰富的鉴赏家", "过度活跃的外倾者", "过度的享乐主义者", "用忙碌躲开痛 · 痛苦需要被看见", "停不下来 · 先停下一件事", "内在很慌乱 · 请立即寻求支援"],
  力量: ["宽怀大度的人", "自信的人", "建设性的挑战者", "实干的冒险家", "执掌实权的掮客", "强硬的对手", "容易硬碰硬 · 先放下一件武器", "觉得无所不能 · 世界不是敌人", "攻击指向一切 · 请寻求支持"],
  和平: ["有自制力的楷模", "有感受力的人", "有力的和平缔造者", "迁就的角色扮演者", "置身事外的人", "隐修的宿命论者", "习惯性回避 · 你的声音还在", "和自己断了线 · 请回到身体里", "存在感快熄灭 · 请立即寻求支援"],
}
