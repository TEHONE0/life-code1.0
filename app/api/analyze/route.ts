...
Q08 · DEFENSE_RESPONSE（被指出问题时的第一反应，1能反思→4反击/回避；健康层级与全局调制的关键信号）：
${answers.defense || "未填写"}
...
Q08 · DEFENSE_RESPONSE (first reaction when a flaw is pointed out, 1=reflects → 4=attacks/avoids; key signal for health level and global tuning):
${answers.defense || "not filled"}

Q09 · DIMENSION_SCAN (consciousness dimension):
